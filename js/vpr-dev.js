...
//This creates the news items but hides them as the RSS display is horrid
	...
	var news_images = [
		"http://www.virginia.edu/vpr/images/panu.header.jpg",
		"http://www.virginia.edu/vpr/images/sponsored_research_2017.jpg"];
	...
	function append_new_news_items(titles, bodies, more_link){
		...
		for(var i = 0 ; i < titles.length; i++){
			...
			news_item.innerHTML = "<div class='row'><div class='col-sm-4'><a href='" + 
				more_link[i].href + 
				"'><img class='news-img' src='" + news_images[i % news_images.length] + "'/></a></div>"+
